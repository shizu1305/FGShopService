                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                    ...
                                                    <select class="form-control" data-style="btn-success" name="gender">
                                                        ...
                                                        echo $users->gender == 'MALE'? 'selected' : ''?>>MALE</option>
                                                        <option value="FEMALE" <?php
                                                        echo $users->gender == 'FEMALE'? 'selected' : ''?>>FEMALE</option>
                                                    </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                             ...
                                             <div class="col-xs-3">
                                                    ...
                                                    <select class="form-control" data-style="btn-success" name="is_social">
                                                        ...
                                                        echo $users->is_social == 'YES'? 'selected' : ''?>>YES</option>
                                                        <option value="NO" <?php
                                                        echo $users->is_social == 'NO'? 'selected' : ''?>>NO</option>
                                                    </select>
                                            </div>
                                            ...
                                            <div class="col-xs-3">
                                                    ...
                                                    <select class="form-control" data-style="btn-success" name='status'>
                                                        ...
                                                        echo $users->status == 'ACTIVE'? 'selected' : ''?>>ACTIVE</option>
                                                        <option value="INACTIVE" <?php
                                                        echo $users->status == 'INACTIVE'? 'selected' : ''?>>INACTIVE</option>
                                                    </select>
                                            </div>
