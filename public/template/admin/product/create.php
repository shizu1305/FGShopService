                  ...
                  <div class="row">
                   ...
                   <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              <label>Infor</label>
                              <textarea rows="5" name="infor" type="textarea" class="form-control border-input" placeholder="Infor">
                              </textarea>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <textarea rows="5" name="desc" type="textarea" class="form-control border-input" placeholder="Desc">
                              </textarea>
                          </div>
                      </div>
                    </div>
