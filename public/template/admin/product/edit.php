                  ...
                  <div class="row">
                   ...
                   <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              <label>Infor</label>
                              <textarea rows="5" cols="50" name="infor" type="textarea" class="form-control border-input" placeholder="Infor">
                                <?=$object->infor?>
                              </textarea>
                          </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <textarea rows="5" cols="50" name="desc" type="textarea" class="form-control border-input" placeholder="Desc">
                                <?=$object->desc?>
                              </textarea>
                          </div>
                      </div>
