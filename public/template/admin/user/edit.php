                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="password" type="password" class="form-control border-input" placeholder="Password" value="<?=$object->password?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-3">
                        ...
                        <select class="form-control" data-style="btn-success" name="is_social">
                            <option value="YES" <?php echo $object->is_social == 'YES'? 'selected' : ''?>>YES</option>
